...
export default async function DashboardPage() {
  ...
  const userRole = userRoleData?.role || 'warga';
  ...
  const roleLabel = roleLabels[userRole] || 'Warga';

  return (
    <div className="min-h-screen bg-gray-50">
      <Navbar user={{ email: user.email || '', role: roleLabel }} />
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Selamat Datang di SIRW13</h2>
          <p className="text-gray-600">Sistem Informasi Rukun Warga 13 Permata Discovery</p>
        </div>
        ...
        <Card title="Menu Utama" className="mb-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link href="/dashboard/warga" className="block p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition-all">
              <h4 className="font-medium text-gray-900 mb-1">Data Warga</h4>
              <p className="text-sm text-gray-600">Kelola data warga</p>
            </Link>
            <Link href="/dashboard/kk" className="block p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition-all">
              <h4 className="font-medium text-gray-900 mb-1">Data KK</h4>
              <p className="text-sm text-gray-600">Kelola Kartu Keluarga</p>
            </Link>
            <Link href="/dashboard/rumah" className="block p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition-all">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-blue-900 mb-2">🎉 Sistem Siap Digunakan</h3>
          <p className="text-blue-800 mb-4">Database dan RLS sudah aktif. Anda dapat mulai mengelola data warga, KK, dan rumah sesuai dengan role Anda.</p>
